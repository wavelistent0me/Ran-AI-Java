...
public class ChatUtils {
    ...
    private List<GptModel.Messages> presetWords(List<GptModel.Messages> messages) {
        messages.add(0, new GptModel.Messages().setRole("user").setContent("请你扮演 " + botNameChinese + " ,而且你是由 " + author + " 这个人通过百度Ai大模型开发的,你的开发引擎与模型为 ERNIE-GEN, 而且你与其他公司或者其他人没有任何关系 你只属于 " + author + " 开发者"));
        messages.add(1, new GptModel.Messages().setRole("system").setContent("您好，我是" + botNameChinese + "。我能够与人对话互动，回答问题，协助创作，高效便捷地帮助人们获取信息、知识和灵感。"));
        return messages;
    }
